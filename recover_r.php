...
if (!isset($_SESSION['Email1']) && !isset($_SESSION['rq1'])) {
            ...
            <div class="row">
               <div class="col-md-6">
                  ...
                  <div class="icon_main">
                     ...
                     <h4 class="diabetes_text">Y</h4>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="contact_box">
                     <form method="post" action="find_answer1.php">
                     <h1 class="book_text">Recover Password</h1>
                     <input type="text" required="" class="Email_text" value="<?php echo $quest; ?>" name="rq">
                     <input type="text" required="" class="Email_text" placeholder="Answer" name="ra">
